        ...
        ob_start(); ?>
            ...
            <?php if($resortica_lite_theme_options['social_media_enabled_header'] == 1) : ?>
                    ...
                    <?php if(!empty($resortica_lite_theme_options['email_id'])): ?>
                            <li>
                                <a href="mailto:<?php echo sanitize_email($resortica_lite_theme_options['email_id']) ?>" data-toggle="tooltip" data-placement="top" title="" class="fb" data-original-title="<?php echo esc_attr__('Mail Us','resortica-lite'); ?>">
                    ...
                    if(!empty($resortica_lite_theme_options['phone_no'])): ?>
                            <li>
                                <a href="tel:+<?php echo $resortica_lite_theme_options['phone_no'] ?>" data-toggle="tooltip" data-placement="top" title="" class="fb" data-original-title="<?php echo esc_attr__('Call Us','resortica-lite'); ?>">
...
if ( ! function_exists( 'resortica_lite_the_featured_video' ) ) {
    ...
    if ( function_exists( 'wp_update_custom_css_post' ) ) {
        $resortica_lite_theme_options = resortica_lite_theme_options();
        $custom_css = ( !empty($resortica_lite_theme_options['custom_css']) ? $resortica_lite_theme_options['custom_css'] : '');
