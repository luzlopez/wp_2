 ...
 * @access public
 */
final class Resortica_Lite_Discount_Customize {
	...
	public function sections( $manager ) {
		...
		$manager->register_section_type( 'Resortica_Lite_Discount_Customize_Section_Pro' );
...
Resortica_Lite_Discount_Customize::get_instance();
