      ...
      <div class="copyright">
          <div class="container">
              <div class="row">
                ...
                <div class="col-md-6">
                     <p><?php echo esc_html__('Made with ', 'resortica-lite'); ?>  <span>  <i class="fa fa-heart"></i>  </span><?php echo esc_html__('By ', 'resortica-lite'); ?><a href="<?php echo esc_url('https://codethemes.co/');?>" target="_blank"><?php echo esc_html__('Code Themes', 'resortica-lite'); ?></a></p>
                </div>

                <div class="col-md-6">
                <nav class="list-inline pull-right">
                    
					<?php wp_nav_menu( array( 'theme_location' => 'footer', 'menu_id' => 'footer-menu','container' => '','items_wrap' => '%3$s', 'fallback_cb' => '__return_false' ) );?>
