...
if ( $action == NULL ) {
	if (!file_exists($lmm_pro_readme)) {
		...
		echo '<div class="pro-upgrade-logo-rtl" ' . $override_css . '><img src="' . LEAFLET_PLUGIN_URL . 'inc/img/logo-mapsmarker-pro.svg" alt="Pro Logo" title="Maps Marker Pro Logo" width="100" height="100" /></div>';
		...
		echo '<p style="clear:both;">
			<div id="pro-features">
				...
				<p>
				<a class="pro-upgrade-external-links" href="https://www.mapsmarker.com/pro-feature-leaflet-changelog" target="_blank">' . sprintf(__('Click here to get the full changelog for leaflet.js v%1s currently integrated in the pro version','lmm'), '1.2.0 (08/2017)') . '</a> (' . sprintf(__('v%1s is used in the free version','lmm'), '0.7.7 (10/2015)') . ')
				</p>
				</div>
				...
				<span class="pro-feature-header">' . __('GPX tracks, elevation charts and waypoints','lmm') . '</span>
				<div class="pro-feature-content" style="background:' . $bgcolor . ';">
				<p style="margin:0 0 10px 0;">
				...
				<p>
				<a class="pro-upgrade-external-links" href="https://www.mapsmarker.com/v4.0" target="_blank">' . __('Click here to get more information about this pro feature on mapsmarker.com','lmm') . '</a>
				</p>
				</div>
				<p><a href="#top" class="upgrade-top-link">' . __('back to top to start free 30-day-trial','lmm') . '</a></p>

				<span class="pro-feature-header">' . __('Augmented-reality support using layar.com API','lmm') . '</span>
				<div class="pro-feature-content" style="background:' . $bgcolor . ';">
				<p style="margin:0 0 10px 0;">
				' . __('Markers can also be displayed via Augmented-Reality technology powered by layar on mobile devices.:','lmm') . '
				</p>
				<img src="' . LEAFLET_PLUGIN_URL . 'inc/img/help-layar.jpg">
				<p>
				<a class="pro-upgrade-external-links" href="https://www.mapsmarker.com/v4.0" target="_blank">' . __('Click here to get more information about this pro feature on mapsmarker.com','lmm') . '</a>
				</p>
				</div>
				...
				<span class="pro-feature-header">' . __('Optimized viewport on mobile devices','lmm') . '</span>
				<div class="pro-feature-content" style="background:' . $bgcolor . ';">
				<p>
				...
				<ul style="list-style-type:disc;margin-left:15px;margin-top:0;">
					...
					<li><a class="pro-upgrade-external-links" href="https://www.mapsmarker.com/v4.0p" target="_blank">' . __('fractional zoom support','lmm') . '</a></li>
					<li><a class="pro-upgrade-external-links" href="https://www.mapsmarker.com/v4.0p" target="_blank">' . __('display list of markers right or left to layer maps','lmm') . '</a></li>
				</ul>
				</div>
				<p><a href="#top" class="upgrade-top-link">' . __('back to top to start free 30-day-trial','lmm') . '</a></p>
