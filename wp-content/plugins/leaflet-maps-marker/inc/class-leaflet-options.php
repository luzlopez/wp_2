...
class Class_leaflet_options {
	...
	public function __construct() {
		...
		$this->sections['basemaps-stamen_maps']		= esc_attr__( 'Stamen Maps', 'lmm' ) . '</li><li>&nbsp';
		...
		$this->sections['ar-layar']				= esc_attr__('Layar settings','lmm');
	...
	public function get_settings() {
		...
		*/
		...
		$this->_settings['defaults_layer_listmarkers'] = array(
			...
			'std'     => '1',
			'choices' => array(
				'0' => __('hide list of markers','lmm'),
				'1' => __('show below the map','lmm'),
			)
		);
		...
		*/
		...
		$this->_settings['mlm_filter_controlbox_batch_selection'] = array(
			...
			'pane'    => 'mapdefaults',
			'section' => 'mapdefaults-filtering',
			'title'   => __('Batch selection buttons','lmm') . $pro_button_link . '<br/><img src="'. LEAFLET_PLUGIN_URL .'inc/img/filter-batch-selection.png" width="138" height="76" />',
...
$this->_settings['clustering_helptext2'] = array(
		...
		*/
		...
		$this->_settings['map_interaction_options_fractionalzoom'] = array(
			...
			'section' => 'mapdefaults-interaction',
			'std'     => '',
			'title'   => '<h3 class="h3-lmm-settings">' . __('Fractional zoom settings','lmm') . '</h3>',
			'desc'    => '',
			'type'    => 'helptext'
		);
		...
		*/
		...
		$this->_settings['map_home_button'] = array(
			...
			'pane'    => 'mapdefaults',
			'section' => 'mapdefaults-control',
			'title'   => __('Home button','lmm') . $pro_button_link . '<br/><img src="'. LEAFLET_PLUGIN_URL .'inc/img/help-home-button.png" width="52" height="45" />',
		...
		$this->_settings['basemap_control_position'] = array(
			...
			'pane'    => 'mapdefaults',
			'section' => 'mapdefaults-control',
			'title'   => __('basemap control position','lmm') . $pro_button_link . '<br/><img src="'. LEAFLET_PLUGIN_URL .'inc/img/basemap-control-position.png" width="59" height="60" />',
		...
		*/
		$this->_settings['gpx_helptext'] = array(
			...
			'std'     => '',
			'title'   => '',
			'desc'    => '<a style="background:#f99755;display:block;padding:3px;text-decoration:none;color:#2702c6;width:635px;margin:10px 0;" href="' . LEAFLET_WP_ADMIN_URL . 'admin.php?page=leafletmapsmarker_pro_upgrade">' . __('This feature is available in the pro version only! Click here to find out how you can start a free 30-day-trial easily','lmm') . '</a><img src="'. LEAFLET_PLUGIN_URL .'inc/img/help-gpx.jpg" /><br/><br/>' . __( 'Settings below will be applied to all GPX tracks added to marker or layer maps.', 'lmm'),
			'type'    => 'helptext'
		);
		...
		*/
		...
		$this->_settings['misc_qrcode_size'] = array(
			...
			'desc'    => __( 'Width and height in pixel of QR code image for marker/layer standalone fullscreen map links', 'lmm' ) . '<div style="height:130px;"></div>',
			'std'     => '150',
			'type'    => 'text'
		);
		...
		*/
		...
		$this->_settings['geocoding_algolia_countries'] = array(
			...
			'desc'    => sprintf(__('Change the countries to search in. You can pass two letters country codes (<a href="%1$s" target="_blank">ISO 639-1</a>). Default: Search on the whole planet.','lmm'), 'https://en.wikipedia.org/wiki/ISO_3166-1#Officially_assigned_code_elements'),
			'std'     => '',
			'type'    => 'text'
		);
		...
		*/
		$this->_settings['geocoding_google_geocoding_helptext'] = array(
			...
			'std'     => '',
			'title'   => '',
			'desc'    => sprintf(__('For terms of services, pricing, usage limits and more please visit %1$s', 'lmm'), '<a href="https://www.mapsmarker.com/google-geocoding" target="_blank">https://www.mapsmarker.com/google-geocoding</a>'),
			'type'    => 'helptext'
		);
		...
		$this->_settings['geocoding_google_geocoding_api_key'] = array(
			...
			'desc'    => sprintf(__('For a tutorial on how to register a Google API server key for "Google Places API Web Service" and "Google Maps Geocoding API", please <a href="%1$s" target="_blank">click here</a>','lmm'),'https://www.mapsmarker.com/google-geocoding'),
			'std'     => '',
			'type'    => 'text'
		);
		...
		*/
		$this->_settings['google_maps_api_key_helptext'] = array(
			...
			'std'     => '',
			'title'   => '',
			'desc'    => __( 'If you want to use Google Maps, you have to register a personal Google Maps Javascript API key.','lmm') . '<br/>' . sprintf(__('For terms of services, pricing, usage limits and more please visit %1$s', 'lmm'), '<a href="https://www.mapsmarker.com/google-maps-javascript-api" target="_blank">https://www.mapsmarker.com/google-maps-javascript-api</a>'),
			'type'    => 'helptext'
		);
		...
		*/
		$this->_settings['ar_general_helptext1'] = array(
			...
			'std'     => '',
			'title'   => '',
			'desc'    => '<a style="background:#f99755;display:block;padding:3px;text-decoration:none;color:#2702c6;width:635px;margin:10px 0;" href="' . LEAFLET_WP_ADMIN_URL . 'admin.php?page=leafletmapsmarker_pro_upgrade">' . __('This feature is available in the pro version only! Click here to find out how you can start a free 30-day-trial easily','lmm') . '</a>' . sprintf(__( 'Markers can also be displayed via Augmented-Reality technology powered by <a href="%1$s" target="_blank">layar</a> on mobile devices.', 'lmm'), 'https://www.layar.com', 'http://www.wikitude.com') . '<br/><br/><img src="'. LEAFLET_PLUGIN_URL .'inc/img/help-layar.jpg" />',
			'type'    => 'helptext'
		);
	...
	*/
	...
	public function save_defaults_for_new_options() {
		...
		if (version_compare(get_option('leafletmapsmarker_version'),'3.12.2','='))
		{
			$new_options_defaults = array();
			foreach ( $this->settings as $id => $setting )
			{
