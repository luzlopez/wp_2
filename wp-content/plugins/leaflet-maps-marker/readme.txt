...
* [latest [leaflet.js](http://www.leafletjs.com) version for higher performance & usability](http://www.leafletjs.com)
...
* display [GPX tracks, elevation chars and waypoints](https://www.mapsmarker.com/pro-feature-gpx)
* [display your markers in the augmented-reality browser layar](https://www.mapsmarker.com/layar)
...
* support for [GeoJSON import and export](https://www.mapsmarker.com/import-export) for bulk additions and bulk updates of markers
...
32. Pro preview: showing marker in layar (via Augmented-Reality API)
...
MapsMarker &reg;
Copyright 2011-2018, MapsMarker.com e.U., All Rights Reserved
...
== Changelog ==
compatibility & security fixes - see [https://www.mapsmarker.com/v3.12.2](https://www.mapsmarker.com/v3.12.2) for more details
