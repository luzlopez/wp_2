...
Tags: page builder, visual editor, drag and drop builder, front-end page builder, homepage builder, landing page builder, site builder, visual builder, website builder, wysiwyg builder
...
Page Builder Sandwich is the friendliest drag and drop landing page builder for front-end editing.

== Description ==

Page Builder Sandwich is a <strong>front-end, drag & drop, visual page builder</strong> that lets you create beautiful pages, and lets you design them effortlessly.
...
= Lets Beginners Design Like a Pro =
...
= Live Editing: Work on Your Page in Real Time =
...
Page Builder Sandwich lets you have your way! Simply drag and drop to rearrange your page layout. Change and tweak sizes, colors, and styles with little to no limitation. Add borders, effects, and more to give your site that design boost that it needs.

= Edit on Both Backend and Frontend, Without Messing Up the Code =
Another feature that makes this website builder ultra-flexible is how it lets you tinker with your content on backend, while still having the ability to design content on frontend. No need to worry about messing up your code! You can use the background WordPress content editor that you already know to fine tune your website content.

= User-Friendly and Efficient =
Boost your productivity by using Page Builder Sandwich’s many shortcuts and quick features:

 * Click and type directly on your content to edit your text
 * Use our always-present text formatting bar to style your text
 * Ctrl+Z / Cmd+Z to undo (plus Ctrl+V / Cmd+V, and more!)
 * Live Editing: Drag images in your browser from your Windows Explorer / Finder to
   add them or choose from pixel-perfect vector icons
 * Add raw HTML, widgets, sidebars, shortcodes, Google Maps, vector
   icons, and plenty more
 * View your site in desktop, tablet or mobile phone and edit your site
   in Responsive Mode

= Full Page Niche-Based Templates =
We have 10 templates (and more coming soon) based on niches and industries that you can draw inspiration and edit from. This way, you don’t need to start building your site from scratch. Tweak the template’s colors, change images, and the entire look and feel of it to suit your site’s style.

= Global Shortcode Mapping =
Our Global Shortcode Mapping Feature lets you place almost any shortcode on your site. This means you don’t need to manually input your shortcodes yourself - we’ve already done that for you. Just paste them and you’re all set.

= Compatible with any theme and plugin =
No need to worry about compatibility issues: We have hundreds of plugins listed in our shortcode mapping database, complete with attribute descriptions to boot. We’ve included <strong>NextGEN Gallery, JetPack, ACF, WooCommerce, Shortcodes Ultimate, bbPress</strong>, and more.

The same goes with your favorite WordPress themes. Choose from the <strong>WordPress.org theme repository, Genesis Themes, StudioPress Themes, Elegant Themes</strong> and themes from <strong>ThemeForest</strong>!

= Mobile Viewing and Editing =
On top of all that, Page Builder Sandwich also gives you the ability to view and edit your content in 3 modes: <strong>desktop, tablet, and mobile</strong> Now you’ll be able to check how your visitors see your website across all devices!

= Get Even More Awesome Features with Page Builder Sandwich Premium! =

While this free version gets the job done, there're more design-oriented features in the premium builder:
 ...
 * Add entrance animations to each element
 * Additional design tools: Video background, Carousels, Tint
   Backgrounds, Count Up Numbers, Countdown, Toggle Text, Tables and
   Pricing Tables, Stylish Shadows, Icon Tooltips
 * Add your own CSS Classes & IDs
 * Access to pre-designed sections and templates
 * And more!

= Translations =
PBS is also available in the following languages, with a little help from some our friends (you can contribute, too!):
...
Page Builder Sandwich has Documentations and Forums for immediate solutions, and also provides one-on-one support for its users. Drop us a line at support@pagebuildersandwich.com for any inquiries you might have.

> Please note that while we prioritize Premium Users, you can feel free to hit us up, and we’ll get back to you as soon as we can!

= Lastly =

We believe that Page Builder Sandwich is the best free WordPress website builder, and we are dedicated to making it better with every version iteration. If you also think so too, [show your support for PBS by rating us](https://wordpress.org/support/plugin/page-builder-sandwich/reviews/#new-post)!
...
4. Visit any post or page in your backend or front-end
5. Click the Page Builder Sandwich button on the top of the page and start building your page!
...
2. Live page editing & formatting capabilities
3. Live page editing & rendered shortcode output
...
Normally, you would edit the contents of your webpage using the backend editor. With Page Builder Sandwich, you can now visit your webpage and edit it in the front-end. Not only that, now you'll be able to design your pages better with the elements and templates we provide.

**Can I use other plugins with Page Builder Sandwich?**

Yes you can! Shortcodes and Widgets from your active plugins should show up inside Page Builder Sandwich automatically. Drag them into your page to use them, if the shortcode is already in our system, then you'll also be presented with a list of the options you can use with your shortcode.

**Will the theme I'm using work with Page Builder Sandwich?**

Yes it should! Page Builder Sandwich only deals with the content of your page, so the other areas like your header, footer and sidebars will remain as is. Go ahead and try it out in your site first.

**Do I need to know how to code to use Page Builder Sandwich?**

Nope! Page Builder Sandwich is designed to be as friendly as possible. You don't need any programming skills to design beautiful pages.

**I'm using Visual Composer, can I also use this?**

If you're currently using another page builder like Visual Composer, Elementor or Beaver Builder, then you can still give Page Builder Sandwich a spin. The pages you've already designed using other page builders would still work fine as usual. Just don't edit a page using multiple page builders at the same time.

**Will this slow down my site?**

Definitely not! Speed is important to us, so we only load what's necessary. Your website visitors won't feel any slowdowns. What's more is that you can readily use caching plugins or CDNs without issues.

**I need more information!**

If you need more information, you can visit our [Documentation](http://docs.pagebuildersandwich.com) for more frequently asked questions, troubleshooting guides, tips and tricks.
...
= 4.4.5 =
* Fixed: Added setting for Google Map API Key. You will now need to enter one for the Map element to work.
* Updated: Google Font list
* Enhanced: Updated Freemius SDK to v2.1.3
